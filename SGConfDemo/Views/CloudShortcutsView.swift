...
struct CloudShortcutsView: View {
    let items: [ShortcutItem] = [
            ...
            ShortcutItem(name: "Send Session Message", url: "https://www.icloud.com/shortcuts/1c45fb64797646dba38f5b045f8d4840", details: "It gets the current seesion from the app and prompts you to send a message.. *** This shortcut will only work on if you are on the Session Detail View. ***")
        ]
