...
extension Speaker {
    static let klemens: Speaker = Speaker(
        ...
        bio: "Indie Developer, 2 x Finalist and 1 x Winner of Apple Design Award \n\nKlemens recently launched his app called StudySnacks, Turn learning 🧑‍🎓 into a tasty game. Check out his apps at https://strasser.app/",
    ...
    static let carola: Speaker = Speaker(
        id: UUID(),
        name: "Carola Nitz",
        bio: "iOS Developer at Netflix \n\nCarola Nitz is an iOS developer who’s shaped apps like Netflix and VLC 📱. Passionate about connecting with the community, she founded Women Who Code Berlin.",
    ...
    static let christian: Speaker = Speaker(
        ...
        bio: "iOS Developer \n\nChristian is known for creating innovative apps such as Apollo (1M+ downloads), Juno for Apple Vision Pro 🥽, and PixelPals 🐾. A former Apple engineer, his deep expertise in design sets him apart in the iOS community.",
    ...
    static let paul: Speaker = Speaker(
        id: UUID(),
        name: "Paul Hudson",
        bio: "Author & Educator at Hacking with Swift \n\nPaul Hudson has taught thousands of developers Swift through Hacking with Swift, a go-to platform for coders worldwide. 📚\nFrom tech journalism to building apps, Paul has written over 20 books and developed tools for companies like Apple and Fender. When he’s not coding, you’ll find him solving Rubik’s cubes or spending time with his dogs. 🐕",
    ...
    static let jane: Speaker = Speaker(
        id: UUID(),
        name: "Jane Chao",
        bio: "iOS Educator and Content Creator \n\nJane is making coding accessible and engaging for Swift developers, with over 9,000 subscribers on her growing YouTube channel 🎬 ChaoCode. \n\nShe’s currently building Simple LLM, a macOS chatbot designed for iOS enthusiasts, integrating OpenAI and open-source models with advanced Retrieval-Augmented Generation for smarter responses 🤯. \n\nA fan of SwiftUI and experienced in backend development on Google Cloud Platform, Jane’s bilingual tutorials in Chinese are inspiring a new generation of coders to dive into iOS development and tech 💻.",
    ...
    static let riana: Speaker = Speaker(
        id: UUID(),
        name: "Riana Soumi",
        bio: "Software Engineer at DeNA \n\nAn iOS engineer with a sharp eye for clean, efficient coding.\n\nRiana blends full-stack know-how with a deep focus on modern iOS and Swift practices. Fresh from her debut at DeNA TechCon, where she unpacked the secrets to effective unit testing, she’s ready to bring her expertise to iOSConfSG.\nFrom crafting powerful iOS solutions to exploring the world as a traveler and content creator, Riana’s journey fuels her approach to development.\nJoin her to get practical Swift Testing insights that go beyond code and push you to think differently.",
    ...
    static let charlie: Speaker = Speaker(
        ...
        bio: "Dev Advocate at RevenueCat \n\nWhen I’m not doing my day job as Developer Advocate at RevenueCat, I develop an indie iOS app called Dark Noise and podcasting at LaunchedFM.",
    ...
    static let dai: Speaker = Speaker(
        id: UUID(),
        name: "Dai Ming",
        bio: "Lead iOS Developer at Kuaishou \n\nKnown for “Learn iOS Programming with Dai Ming” and “GeekTime’s iOS Development Master Course\", Dai Ming has driven iOS performance at top companies like Kuaishou, Alibaba, and Didi. From mastering compilation to optimizing every detail on iOS and macOS, his insights are a game-changer. \nCatch Dai Ming at iOSConfSG - this is one session you won’t want to miss.",
    ...
    static let krzysztof: Speaker = Speaker(
        ...
        bio: "Principal Swift Engineer \n\nAs a Principal Swift Engineer, Krzysztof is shaping the future of Apple platforms with tools adopted by 80K+ teams, from Apple to Disney. 🏆 2x Engineering Emmy winner, co-founder of Pixle, and creator of Foldify & Sourcery for Xcode.",
    ...
    static let mustafa: Speaker = Speaker(
        id: UUID(),
        name: "Mustafa Yusuf",
        bio: "Indie Developer \n\nThe incredible indie developer who is making waves with his apps Tasks and Karo. \nBoth apps have been featured by Apple and have achieved an impressive total of over half a million downloads. \nMustafa has received several accolades, including \"The Shippies\" award for Karo. He also had the honour of being a keynote speaker at the grand opening of Apple’s Developer Center in Bangalore. As a pioneer in app development since the early days of Swift, he is at the forefront of innovation. \nHis journey is filled with insightful experiences that will inspire every Swift developer.",
